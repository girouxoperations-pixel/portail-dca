              ...
              <>
                ...
                <div className="flex items-center gap-3">
                  ...
                  <div className="flex-1 flex flex-col gap-0.5">
                    ...
                    <input
                      ...
                      onChange={ev => { const next = [...autreAmounts]; next[0] = Number(ev.target.value); setAutreAmounts(next) }}
                      required
                ...
                {autreDates.map((date, i) => (
                  <div key={i} className="flex items-center gap-2">
                    ...
                    <div className="flex-1 grid grid-cols-2 gap-2">
                      <div className="flex flex-col gap-0.5">
                        ...
                        <input
                          ...
                          onChange={e => { const next = [...autreDates]; next[i] = e.target.value; setAutreDates(next) }}
                          required
                      ...
                      <div className="flex flex-col gap-0.5">
                        ...
                        <input
                          ...
                          onChange={ev => { const next = [...autreAmounts]; next[i + 1] = Number(ev.target.value); setAutreAmounts(next) }}
                          required
                          className="px-2 py-1.5 rounded border border-violet-200 bg-white text-sm text-gray-900 focus:outline-none focus:ring-2 focus:ring-violet-500 tabular-nums"
                        />
                      </div>
                    ...
                    {autreDates.length > 1 && (
                      <button type="button"
                        onClick={() => { setAutreDates(autreDates.filter((_, j) => j !== i)); setAutreAmounts(autreAmounts.filter((_, j) => j !== i + 1)) }}
                ...
                >
                  <Plus size={12} />Ajouter un versement
                </button>
              </>
            ) : (
              <>
